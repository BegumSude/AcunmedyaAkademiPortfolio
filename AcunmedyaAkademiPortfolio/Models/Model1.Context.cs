...
namespace AcunmedyaAkademiPortfolio.Models
{
    ...
    public partial class DbAcunMedyaAkademiPortfolioEntities2 : DbContext
    {
        public DbAcunMedyaAkademiPortfolioEntities2()
            : base("name=DbAcunMedyaAkademiPortfolioEntities2")
        {
        }
